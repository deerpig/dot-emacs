...
;; Hydra Key Bindings ============================================
    ...
    (global-set-key (kbd "H--") 'hydra-dash/body)
    (global-set-key (kbd "H-d") 'help/hydra/timestamp/body)
#+end_src
...
** Dash Hydra
:PROPERTIES:
:ID:       a7c50dc4-d3a9-402d-a414-66a8b160672e
:END:

#+begin_src emacs-lisp
(defhydra hydra-dash (:color blue :hint nil :timeout 20)
  "
                                                                         ╭─────────┐
                                                                         │ Dashes  │
 ╭───────────────────────────────────────────────────────────────────────┴─────────╯
   Em Dash — [_-_] En Dash –  [_=_]
"
