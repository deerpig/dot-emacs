...
(defhydra hydra-elfeed ()
   "filter"
   ("c" (elfeed-search-set-filter "@6-months-ago +comic")   "comics")
   ("e" (elfeed-search-set-filter "@6-months-ago +emacs")   "emacs")
   ("t" (elfeed-search-set-filter "@6-months-ago +tech")    "tech")

   ("b" (elfeed-search-set-filter "@6-months-ago +boing")   "bb")
   ("s" (elfeed-search-set-filter "@6-months-ago +slash")   "/.")
   ("t" (elfeed-search-set-filter "@6-months-ago +ars")     "ars")
   ("d" (elfeed-search-set-filter "@6-months-ago +torrent") "torrent")
   ("t" (elfeed-search-set-filter "@6-months-ago +longnow") "long")
