...
(defhydra hydra-elfeed (:color blue :hint nil)
 ...
 ╭───────────────────────────────────────────────────────────┤     Today [_T_]  
  Feeds: Boing Boing [_b_] Slashdot [_/_]   Ars Technica [_a_]     │   Starred [_*_]  
          Cool Tools [_o_] Long Now [_l_]   YouTube      [_y_]     │    Marked [_M_]
...
Timestamps: (_s_pace)
  Date: _i_so, _u_s, US With _y_ear and _d_ashes, US In _W_ords
   Date/Time: _n_o Colons or _w_ith
    Org Active: _R_ight Now or _C_hoose
    Org Inactive: _r_ight Now or _c_hoose
"
  ("s" nil)
  ...
  ("C" org-time-stamp)
  ("r" help/org-time-stamp-inactive-with-seconds-now)
