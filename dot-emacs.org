...
At the moment I only have a weather API in my emacs config, all email
accounts and password info is in other applications.  So setting this
up is on my TODO list but isn't high priority.
