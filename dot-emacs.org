...
recruits are trained with M1 Carbiness.  These are single shot
(they have a magazine? so what do you call them) rifiles.  They are
bog standard refiles  -- learn the basics, the use M-16s in the field.

The M1 is bog standard emacs, start with that, learn that, master
that.  What I did was force myself to use emacs in a shell on a remote
