...
*** Magit-todos
:PROPERTIES:
:ID:       2d00f0ec-4ceb-4290-84d2-da29f1d4f44a
:END:

  - https://github.com/alphapapa/magit-todos

I love the idea of this package but it's still a bit rough.
...
(global-set-key (kbd "H-W") 'sdcv-search)
#+end_src
...
** Org-mac-grab-link
:PROPERTIES:
:ID:       802ea1ae-24eb-4d0c-8d4b-fd7a2092920a
:END:

tweak org-mac-grab-link to be cross platform and point to a
bash script instead of an applescript...

http://irreal.org/blog/?p=6924
...
** Firefox-Controller
:PROPERTIES:
:ID:       73a7a2d7-47de-434d-b83c-da0036dc6e6c
:END:

https://github.com/cute-jumper/emacs-firefox-controller

Not supported in Quantum
